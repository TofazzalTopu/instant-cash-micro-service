...
import com.info.division.annotation.GetAPIDocumentation;
import com.info.division.annotation.PostApiDocumentation;
...
public class DivisionController {
    ...
    @Operation(summary = "Create a Division.")
    ...
    @GetMapping("/{id}")
    @GetAPIDocumentation
    @Operation(summary = "Find a Division By Id.")
